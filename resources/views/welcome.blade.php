                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
                                ...
                                <h1 class="display-3 text-white animated slideInDown mb-4">La solution à portée de main</h1>
                                <p class="fs-5 fw-medium text-white mb-4 pb-2">Plateforme de mise en relation entre particuliers et prestataires pour services variés (ménage, plomberie, électricité, informatique, menuiserie, ferronnerie, carrelage, peinture, coiffure, chauffeur, maçonnerie, onglerie)..</p>
            ...
            <div class="owl-carousel-item position-relative">
                ...
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(0, 0, 0, .4);">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
                                <h5 class="text-white text-uppercase mb-3 animated slideInDown">dépanage à Domicle</h5>
                                <h1 class="display-3 text-white animated slideInDown mb-4">Intégrité - Varacité et Fiabilité</h1>
