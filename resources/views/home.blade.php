   ...
   <!-- Carousel Start -->
    <div class="container-fluid p-0 mb-5">
        <div class="owl-carousel header-carousel position-relative">
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid" src="img/carrousel_1.jpeg" alt="">
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(0, 0, 0, .4);">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
                                <h5 class="text-white text-uppercase mb-3 animated slideInDown">La Main Pro</h5>
                                <h1 class="display-3 text-white animated slideInDown mb-4">Votre artisan de confiance, disponible quand vous en avez besoin.</h1>
                                <p class="fs-5 fw-medium text-white mb-4 pb-2">Trouvez un artisan qualifié près de chez vous en quelques clics (ménage, plomberie, électricité, informatique, menuiserie, ferronnerie, carrelage, peinture, coiffure, chauffeur, maçonnerie, onglerie).. des professionnels fiables à portée de main</p>
                                <a href="{{ url('/recherche') }}" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Recherche</a>
                                <a href="" class="btn btn-secondary py-md-3 px-md-5 animated slideInRight">Reservation</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid" src="img/carrousel_2.jpeg" alt="">
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(0, 0, 0, .4);">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
                                <h5 class="text-white text-uppercase mb-3 animated slideInDown">Intégrité - Varacité et Fiabilité</h5>
                                <h1 class="display-3 text-white animated slideInDown mb-4">dépanage à Domicle</h1>
                                <p class="fs-5 fw-medium text-white mb-4 pb-2">Un problème ? Trouvez rapidement un expert en dépannage près de chez vous quel que soit votre besoin.</p>
                                <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Recherche</a>
                                <a href="{{ url('/reservation') }}" class="btn btn-secondary py-md-3 px-md-5 animated slideInRight">Reservation</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    @php
        ...
        $images = [
            ...
            'Ménage'        => 'img/secteurs/menage.jpg',

            'Plomberie'     => 'img/secteurs/plombier.png',

            'electricite'   => 'img/secteurs/electricite.png',

            'informatique'  => 'img/secteurs/informatique.jpeg',

            'menuiserie'    => 'img/secteurs/menuisier.png',

            'ferronnerie'   => 'img/secteurs/ferronnerie.jpeg',

            'carrelage'     => 'img/secteurs/carrelage.jpeg',

            'peinture'      => 'img/secteurs/peinture.jpeg',

            'coiffure'      => 'img/secteurs/coiffure.jpeg',

            'chauffeur'     => 'img/secteurs/chauffeur.jpeg',

            'maconnerie'    => 'img/secteurs/maçonnerie.jpeg',

            'onglerie'      => 'img/secteurs/onglerie.jpeg',
    ...
    @foreach($secteurs as $secteur)
        ...
        @php
            ...
            $image = $images[$secteur]
                ?? 'img/secteurs/plombier.png';
